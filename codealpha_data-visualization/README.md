...
Analyzes delivery time distribution across different shipping methods. Shows that shipping times are consistent across ship modes.
...
```bash
jupyter notebook supermarket-visualization.ipynb
```
